...
Phase 8 uses the checked southwest exterior three-quarter composition from the
portable camera skill and manifest. It uses a 28 mm lens and must retain the
full house and pool in frame.
